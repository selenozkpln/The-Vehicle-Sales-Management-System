...
public class ManageCustomers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField5.setText("Customer_ID");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            String id,name,email,mNum;
            while (rs.next()){
                id=rs.getString(1);
                name=rs.getString(2);
                email=rs.getString(3);
                mNum=rs.getString(4);
                String[] row={id,name,email,mNum};
                model.addRow(row);
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            String qry = "INSERT customer SET Customer_ID=?,Name=?,Email=?,MobileNumber=?";
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            ...
            String qry2 = "DELETE FROM customer WHERE Customer_ID=?";
